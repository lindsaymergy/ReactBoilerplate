...
ReactDOM.render(<Avatar alt="Photo of Matt" user="matthewtruty" />, document.getElementById('avatar'));
ReactDOM.render(<Greeter />, document.getElementById('greeter1'));
ReactDOM.render(<NameTag name="David" />, document.getElementById('tag1'));
ReactDOM.render(<Avatar alt="Photo of a Coffee Cup" user="dfederspiel"/>, document.getElementById('avatar1'));
